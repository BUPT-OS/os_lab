...
![](https://raw.githubusercontent.com/Richardhongyu/pic/main/20230309144542.png)
> 1. 下面的`/data/bupt-rtos/linux-dovetail-v5.13-dovetail-rebase`路径和大家看到的`/data/bupt-rtos/rros`路径是等价的。  
