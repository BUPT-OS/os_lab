...
这是一个单人项目，你需要**独立完成**项目。我们提供了若干测试用例，你的代码需要能够通过测试用例。作为我们评分的标准，你需要提交**代码**以及一份简短的**实验报告**。实验报告的内容包括：

* Rust学习心得 or 笔记 or 学习记录 （8分）
* 简要描述你的整体设计（4分）
* 对Rust实现链表其他方法的探究 or 实验中遇到的困难 or 对本实验的内容和难度的反馈 (3分)    
...
| Part 1 | -                                                            | 每个测试点3分，共21分                                 |
| Part 2 | -                                                            | 每个测试点6分，共36分                                 |
| Part 3 |                                                              | 前两个测试点(merge1和merge2)9分，最后一个10分，共28分 |
| 报告   | Rust学习心得 or 笔记 or 学习记录                             | 7分                                           |
|        | 整体设计                                                     | 4分                                           |
|        | 对Rust实现链表其他方法的探究 or 实验中遇到的困难 or 对本实验的内容和难度的反馈 | 4分                                           |
| 总分   |                                                              | 100分                                         |
